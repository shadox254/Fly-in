...
#  Updated: 2026/05/15 10:07:51 by rruiz                                      #
# *************************************************************************** #
...
class ReservationCalendar:
    ...
    turns to prevent collisions and over-capacity 
    scenarios.
    ...
    def is_hub_available(self, hub_name: str, turn: int, max_capacity: int) -> bool:
        ...
        Args:
            ...
            max_capacity (int): The maximum number of drones allowed on the hub.

        Returns:
            bool: True if occupancy is strictly less than max_capacity, False otherwise.
        '''
    ...
    def is_connection_available(self, hub1: str, hub2: str, turn: int, max_capacity: int) -> bool:
        '''Check if a connection between two hubs can accept another drone for a specific turn.
